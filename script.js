...
(function (U, M) {
  "object" === typeof module && module.exports
    ...
    ? define("customcharts/customcharts", function () {
        return M(U);
      })
    : (U.customcharts && U.customcharts.error(16, !0), (U.customcharts = M(U)));
  ...
  function M(a, y, I, L) {
    a.hasOwnProperty(y) ||
      ...
      "function" === typeof CustomEvent &&
        U.dispatchEvent(
          new CustomEvent("customchartsModuleLoaded", {
  ...
  M(a, "Core/Utilities.js", [a["Core/Globals.js"]], function (a) {
    function x(c, b, f, k) {
      const n = b ? "customcharts error" : "customcharts warning";
      32 === c && (c = `${n}: Deprecated member`);
      const r = u(c);
      let e = r
        ? `${n} #${c}: www.customcharts.com/errors/${c}/`
        : c.toString();
    ...
    E(
      ...
      function (c, b) {
        a[b] = function (f) {
          x(32, !1, void 0, { [`customcharts.${b}`]: `use Array.${c}` });
    ...
    const f = (function () {
      ...
      let f = 0;
      return function () {
        return "customcharts-" + (b ? "" : c) + f++;
      };
    })();
    q.jQuery &&
      (q.jQuery.fn.customcharts = function () {
        const c = [].slice.call(arguments);
        if (this[0])
          return c[0]
            ? (new a[L(c[0]) ? c.shift() : "Chart"](this[0], c[0], c[1]), this)
            : k[l(this[0], "data-customcharts-chart")];
      });
    G = {
      ...
      inArray: function (b, f, d) {
        x(32, !1, void 0, { "customcharts.inArray": "use Array.indexOf" });
      ...
      isString: L,
      keys: function (b) {
        x(32, !1, void 0, { "customcharts.keys": "use Object.keys" });
      ...
      const { isTouchDevice: x, svg: B } = I,
        ...
        v = {
          ...
          legend: {
            ...
            align: "center",
            alignColumns: !0,
            className: "customcharts-no-tooltip",
            layout: "horizontal",
            itemMarginBottom: 2,
            itemMarginTop: 2,
  ...
  M(
    ...
    function (a, y) {
      ...
      const t =
        y &&
        u(y.createPolicy) &&
        y.createPolicy("customcharts", { createHTML: (e) => e });
      y = t ? t.createHTML("") : "";
      try {
      ...
      class D {
        ...
        applyTextOutline(b) {
          ...
          if ((f = f[0]) && "none" !== f && I.svg) {
            ...
            m(d, {
              class: "customcharts-text-outline",
              fill: b,
              stroke: b,
              "stroke-width": f,
            ...
            if (m || q.forExport) {
              try {
                var O =
                  this.fakeTS &&
                  function (b) {
                    const c = n.querySelector(".customcharts-text-outline");
                    c && g(c, { display: b });
                  };
                k(O) && O("none");
                J = n.getBBox
        ...
        removeTextOutline() {
          const b = this.element.querySelector(
            "tspan.customcharts-text-outline"
          );
    ...
    function (a, y) {
      ...
      class u extends a {
        constructor(a, l, p, t, m, h, g, e, w, E) {
          ...
          this.className = E;
          this.addClass(
            "button" === E ? "customcharts-no-tooltip" : "customcharts-label"
          );
          E && this.addClass("customcharts-" + E);
            ...
            (this.box ||
              ((a = this.box =
                this.symbolKey
                  ...
                  : this.renderer.rect()),
              a.addClass(
                ("button" === this.className ? "" : "customcharts-label-box") +
                  (this.className
                    ? " customcharts-" + this.className + "-box"
                    : "")
              ),
              a.add(this)),
    ...
    function (a, y, I) {
      ...
      class t {
        ...
        modifyDOM() {
          ...
          [].forEach.call(
            a.element.querySelectorAll("tspan.customcharts-br"),
            (e, d) => {
              e.nextSibling &&
                e.previousSibling &&
                (0 === d &&
              ...
              l = (e) => {
                [].slice.call(e.childNodes).forEach((d) => {
                  d.nodeType === z.Node.TEXT_NODE
                    ? w(d, e)
                    : (-1 !== d.className.baseVal.indexOf("customcharts-br") &&
                        (a.actualWidth = 0),
                      l(d));
                });
              };
        ...
        modifyTree(a) {
          const h = (g, e) => {
            ...
            if ("b" === d || "strong" === d)
              k
                ? (m["class"] = "customcharts-strong")
                : (p.fontWeight = "bold");
            else if ("i" === d || "em" === d)
              k
                ? (m["class"] = "customcharts-emphasized")
                : (p.fontStyle = "italic");
            p && p.color && (p.fill = p.color);
            "br" === d
              ? ((m["class"] = "customcharts-br"),
                (g.textContent = "\u200b"),
                (e = a[e + 1]) &&
                  e.textContent &&
      ...
      class V {
        ...
        init(b, c, f, a, k, n, J) {
          ...
          this.createElement("desc")
            .add()
            .element.appendChild(
              p.createTextNode("Created with customcharts 11.1.0")
            );
        ...
        shadowDefinition(b) {
          const c = [
              `customcharts-drop-shadow-${this.chartIndex}`,
        ...
        button(c, f, d, k, e = {}, q, J, g, r, h) {
          ...
          A.setState = function (b) {
            1 !== b && (A.state = N = b);
            A.removeClass(
              /customcharts-button-(normal|hover|pressed|disabled)/
            ).addClass(
              "customcharts-button-" +
        ...
        g(b) {
          ...
          return b ? c.attr({ class: "customcharts-" + b }) : c;
        }
        image(b, f, d, a, k, n) {
          ...
          b ||
            ...
            (this.gridLine = b =
              p
                .path()
                .attr(d)
                .addClass("customcharts-" + (r ? r + "-" : "") + "grid-line")
                .add(g.gridGroup)));
          if (
            b &&
            (h = g.getPlotLinePath({
          ...
          r &&
            ...
            b ||
              ((this.mark = b =
                d
                  .path()
                  .addClass("customcharts-" + (k ? k + "-" : "") + "tick")
                  .add(g.axisGroup)),
        ...
        addTitle(b) {
          ...
          this.axisTitle ||
            ...
            (this.axisTitle = f
              ...
              .addClass("customcharts-axis-title")),
          ...
          if (!c.axisGroup) {
            const b = (b, c, f) =>
              m
                ...
                .attr({ zIndex: f })
                .addClass(
                  `customcharts-${h.toLowerCase()}${c} ` +
                    (this.isRadial ? `customcharts-radial-axis${c} ` : "") +
                    (v || "")
                )
                .add(r);
        ...
        renderLine() {
          this.axisLine ||
            ((this.axisLine = this.chart.renderer
              .path()
              .addClass("customcharts-axis-line")
              .add(this.axisGroup)),
              ...
              e.forEach(function (b, d) {
                ...
                0 === d % 2 &&
                  ...
                  (r[b].options = {
                    ...
                    to: a ? a.lin2log(G) : G,
                    color: m,
                    className: "customcharts-alternate-grid",
                  }),
                  r[b].render(),
                  (r[b].isActive = !0));
              });
            ...
            g ||
              ((this.cross = g =
                n.renderer
                  .path()
                  .addClass(
                    "customcharts-crosshair customcharts-crosshair-" +
                      (a ? "category " : "thin ") +
                      (f.className || "")
                  )
      ...
      class r {
        ...
        getClassName(a, d, b) {
          ...
          return [
            ...
            "customcharts-label",
            b && "customcharts-tooltip-header",
            d ? "customcharts-tooltip-box" : "customcharts-tooltip",
            !b && "customcharts-color-" + F(a.colorIndex, f.colorIndex),
            c && c.className,
          ]
            .filter(w)
            .join(" ");
        ...
        getLabel() {
          ...
          if (this.label) {
            var e = !this.label.hasClass("customcharts-label");
          ...
          if (!this.label) {
            if (this.outside) {
              ...
              n.className = "customcharts-tooltip-container";
              p(n, {
                position: "absolute",
                top: "1px",
                pointerEvents: c,
        ...
        shouldStickOnContact(a) {
          return !(
            ...
            (a && !this.chart.pointer.inClass(a.target, "customcharts-tooltip"))
          );
        }
        move(a, d, b, f) {
          const c = this,
        ...
        styledModeFormat(a) {
          return a
            .replace('style="font-size: 0.8em"', 'class="customcharts-header"')
            .replace(
              /style="color:{(point|series)\.color}"/g,
              'class="customcharts-color-{$1.colorIndex} {series.options.className} {point.options.className}"'
            );
        }
    ...
    function (a, y, I, L, C) {
      ...
      class G {
        ...
        getClassName() {
          return (
            "customcharts-point" +
            (this.selected ? " customcharts-point-select" : "") +
            (this.negative ? " customcharts-negative" : "") +
            (this.isNull ? " customcharts-null-point" : "") +
            ("undefined" !== typeof this.colorIndex
              ? " customcharts-color-" + this.colorIndex
              : "") +
            (this.options.className ? " " + this.options.className : "") +
            (this.zone && this.zone.className
              ? " " + this.zone.className.replace("customcharts-negative", "")
              : "")
          );
        }
        getGraphicalProps(b) {
        ...
        setState(b, f) {
          ...
          if (
            ...
            if (this.graphic && !this.hasMockGraphic) {
              k && this.graphic.removeClass("customcharts-point-" + k);
              b && this.graphic.addClass("customcharts-point-" + b);
              if (!w.styledMode) {
                ...
                c.options.inactiveOtherPoints &&
                  ...
                  ((this.dataLabels || []).forEach(function (b) {
                    b &&
                      !b.hasClass("customcharts-data-label-hidden") &&
            ...
            g && g.size && E && "hidden" !== u && !this.isCluster
              ? (G || (c.halo = G = w.renderer.path().add(E.parentGroup)),
                ...
                G.attr({
                  class:
                    "customcharts-halo customcharts-color-" +
      ...
      class F {
          ...
          if (!v || !v.touch)
            if (
              ...
              (!d.hasCartesianSeries && !d.mapView) ||
                ...
                v
                  .attr({ class: "customcharts-selection-marker", zIndex: 7 })
                  .add(),
                d.styledMode ||
                  v.attr({
                    fill:
        ...
        onTrackerMouseOut(a) {
          ...
          if (
            !(
              ...
              !a ||
              d.stickyTracking ||
              this.inClass(a, "customcharts-tooltip") ||
              (this.inClass(a, "customcharts-series-" + d.index) &&
                this.inClass(a, "customcharts-tracker"))
            )
          )
            d.onMouseOut();
        }
        inClass(a, k) {
          ...
          for (; a; ) {
            if ((d = B(a, "class"))) {
              ...
              if (-1 !== d.indexOf("customcharts-container")) return !1;
            }
            a = a.parentElement;
          }
        }
        ...
        onContainerClick(a) {
          ...
          const g = d.plotLeft,
            h = d.plotTop;
          d.cancelClick ||
            (e && this.inClass(a.target, "customcharts-tracker")
        ...
        onContainerMouseLeave(a) {
          ...
          d &&
            a.relatedTarget &&
            !this.inClass(a.relatedTarget, "customcharts-tooltip") &&
        ...
        onContainerMouseMove(a) {
          ...
          ("mousedown" === d.mouseIsDown || this.touchSelect(a)) &&
            this.drag(a);
          d.openMenu ||
            (!this.inClass(a.target, "customcharts-tracker") &&
              !d.isInsidePlot(a.chartX - d.plotLeft, a.chartY - d.plotTop, {
                visiblePlotOnly: !0,
              })) ||
            (e && e.shouldStickOnContact(a)) ||
            (this.inClass(a.target, "customcharts-no-tooltip")
              ? this.reset(!1, 0)
        ...
        pinch(a) {
          const d = this,
            ...
            m =
              1 === b &&
              ((d.inClass(a.target, "customcharts-tracker") &&
                e.runTrackerClick) ||
                d.runChartClick),
            p = {};
      ...
      class G {
        ...
        colorizeItem(b, a) {
          ...
          if (c)
            c[a ? "removeClass" : "addClass"](
              "customcharts-legend-item-hidden"
            );
          ...
          J ||
            ((a.group = e
              ...
              .addClass(
                "customcharts-" +
                  t.type +
                  "-series customcharts-color-" +
                  b.colorIndex +
                  (x ? " " + x : "") +
                  (p ? " customcharts-series-" + b.index : "")
              )
              .attr({ zIndex: 1 })
        ...
        render() {
          ...
          l ||
            (this.box = l =
              a
                .rect()
                .addClass("customcharts-legend-box")
          ...
          b && 0 < k && b > k && !1 !== q.enabled
            ? ((this.clipHeight = x =
              ...
              O ||
                ...
                (this.pager = e
                  .text("", 15, 10)
                  .addClass("customcharts-legend-navigation")),
          ...
          0 < m &&
            ...
            [this.up, this.upTracker].forEach(function (b) {
              b.attr({
                class:
                  1 === m
                    ? "customcharts-legend-nav-inactive"
                    : "customcharts-legend-nav-active",
              });
            }),
            h.attr({ text: m + "/" + e }),
        ...
        setItemEvents(b, a, c) {
          const d = this,
            ...
            g = b instanceof L,
            k = "customcharts-legend-" + (g ? "point" : "series") + "-active",
        ...
        createCheckboxForItem(b) {
          b.checkbox = t(
            ...
            {
              type: "checkbox",
              className: "customcharts-legend-checkbox",
              checked: b.selected,
  ...
  M(a, "Core/Legend/LegendSymbol.js", [a["Core/Utilities.js"]], function (a) {
    ...
    (function (a) {
      a.lineMarker = function (a, B) {
        ...
        B.line = t.path().addClass("customcharts-graph").attr(h).add(m);
        ...
        setOptions(b) {
          ...
          (!f.negativeColor && !f.negativeFillColor) ||
            ...
            ((a = {
              ...
              className: "customcharts-negative",
            }),
            b ||
        ...
        animate(b) {
          ...
          if (b && c)
            (e = this.getClipBox()),
              ...
              c.clip(k),
              d && d.clip(n);
          else if (k && !k.hasClass("customcharts-animating")) {
            g = this.getClipBox();
            const b = e.step;
            d &&
            ...
            k.addClass("customcharts-animating").animate(g, e);
          }
        }
        afterAnimate() {
          this.setClip();
          ...
          e.addClass(
            "customcharts-" +
              ...
              (r(this.colorIndex)
                ...
                : "") +
              (this.options.className || "") +
              (e.hasClass("customcharts-tracker")
                ? " customcharts-tracker"
                : ""),
            !0
          );
          ...
          m
            ...
            : b.graph &&
              ((b.tracker = k
                ...
                .addClass(
                  c ? "customcharts-tracker-area" : "customcharts-tracker-line"
                )
                .add(b.group)),
              f.styledMode ||
                b.tracker.attr({
        ...
        setState(b, a) {
          ...
          if (
            ...
            ([c.group, c.markerGroup, c.dataLabelsGroup].forEach(function (a) {
              a &&
                (c.state && a.removeClass("customcharts-series-" + c.state),
                b && a.addClass("customcharts-series-" + b));
            }),
            (c.state = b),
            !c.chart.styledMode)
          ) {
  ...
  M(
    ...
    function (a, y, I, L, C, z, H, B, u, v, l, p, t) {
      ...
      class ea {
        ...
        setClassName(b) {
          this.container.className = "customcharts-container " + (b || "");
        }
        getContainer() {
          const b = this.options,
            a = b.chart;
          ...
          h || Z(13, !0, this);
          var l = W(c(h, "data-customcharts-chart"));
          ba(l) && d[l] && d[l].hasRendered && d[l].destroy();
          c(h, "data-customcharts-chart", this.index);
        ...
        drawChartBox() {
          ...
          w ||
            ((this.chartBackground = w =
              a.rect().addClass("customcharts-background").add()),
            (E = "attr"));
          ...
          v ||
            ...
            (this.plotBackground = v =
              a.rect().addClass("customcharts-plot-background").add()));
          v[E](p);
          f ||
          ...
          u ||
            ...
            (this.plotBorder = u =
              a
                .rect()
                .addClass("customcharts-plot-border")
                .attr({ zIndex: 1 })
                .add()));
          f ||
            u.attr({
        ...
        destroy() {
          ...
          z.chartCount--;
          b.renderTo.removeAttribute("data-customcharts-chart");
          da(b);
        ...
        showLoading(b) {
          ...
          g ||
            (a.loadingDiv = g =
              n(
                "div",
                {
                  className: "customcharts-loading customcharts-loading-hidden",
                },
                null,
                a.container
              ));
          k ||
            ((a.loadingSpan = k =
              n("span", { className: "customcharts-loading-inner" }, null, g)),
            f(a, "redraw", e));
          g.className = "customcharts-loading";
        ...
        hideLoading() {
          const b = this.options,
            a = this.loadingDiv;
          a &&
            ((a.className = "customcharts-loading customcharts-loading-hidden"),
            this.styledMode ||
              m(
                a,
                { opacity: 0 },
        ...
        showResetZoom() {
          ...
          A(this, "beforeShowResetZoom", null, function () {
            a.resetZoomButton = a.renderer
              ...
              .addClass("customcharts-reset-zoom")
              .add()
    ...
    function (a, y, I, L, C, z) {
      ...
      I.prototype.setUpScrolling = function () {
        ...
        this.scrollingParent = u(
          "div",
          { className: "customcharts-scrolling-parent" },
          { position: "relative" },
          this.renderTo
        );
        this.scrollingContainer = u(
          "div",
          { className: "customcharts-scrolling" },
          a,
        ...
        this.innerContainer = u(
          "div",
          { className: "customcharts-inner-container" },
          null,
          this.scrollingContainer
        );
      ...
      I.prototype.moveFixedElements = function () {
        let a = this.container,
          ...
          h =
            ".customcharts-breadcrumbs-group .customcharts-contextbutton .customcharts-credits .customcharts-legend .customcharts-legend-checkbox .customcharts-navigator-series .customcharts-navigator-xaxis .customcharts-navigator-yaxis .customcharts-navigator .customcharts-reset-zoom .customcharts-drillup-button .customcharts-scrollbar .customcharts-subtitle .customcharts-title".split(
              " "
            ),
          g;
        this.scrollablePixelsX && !this.inverted
          ? (g = ".customcharts-yaxis")
          : this.scrollablePixelsX && this.inverted
          ? (g = ".customcharts-xaxis")
        ...
        g &&
          h.push(
            `${g}:not(.customcharts-radial-axis)`,
            `${g}-labels:not(.customcharts-radial-axis-labels)`
          );
        ...
        a
          ? ((this.fixedDiv = u(
            ...
            (this.scrollableMask = l
              ...
              .addClass("customcharts-scrollable-mask")
              .add()),
    ...
    function (a, y, I) {
      ...
      class z extends a {
        ...
        drawGraph() {
          ...
          let l = [["graph", "customcharts-graph"]];
        ...
        getZonesGraphs(a) {
          this.zones.forEach(function (x, u) {
            u = [
              "zone-graph-" + u,
              "customcharts-graph customcharts-zone-graph-" +
                u +
                " " +
                (x.className || ""),
            ];
      ...
      class u extends x {
        ...
        drawGraph() {
          ...
          const a = this,
            l = this.areaPath,
            p = this.options,
            t = [["area", "customcharts-area", this.color, p.fillColor]];
          this.zones.forEach(function (l, h) {
            t.push([
              "zone-area-" + h,
              "customcharts-area customcharts-zone-area-" +
                h +
                " " +
                l.className,
              l.color || a.color,
                    ...
                    (w
                      ...
                      : (w = A
                          ? h
                              ...
                              .addClass("customcharts-data-label")
                          : h.label(
                              F,
                              0,
                              0,
                        ...
                        w.addClass(
                          " customcharts-data-label-color-" +
                            a.colorIndex +
                            " " +
                            (b.className || "") +
                            (b.useHTML ? " customcharts-tracker" : "")
                        ),
                    w &&
                      ((w.options = b),
                      w.attr(r),
            ...
            ? ((d = this.center[0]),
              ...
              this.graph ||
                (this.graph = this.chart.renderer
                  ...
                  .addClass("customcharts-empty-series")
                  .add(this.group)),
              this.graph.attr({
                  ...
                  if ((c = !E))
                    (b.connector = E =
                      e.renderer
                        .path()
                        .addClass(
                          "customcharts-data-label-connector  customcharts-color-" +
                            b.colorIndex +
          ...
          a.oldOpacity !== p &&
            (a.alignAttr && a.placed
              ? (a[p ? "removeClass" : "addClass"](
                  "customcharts-data-label-hidden"
                ),
                (t = !0),
  ...
  a["masters/customcharts.src.js"]._modules = a;
  return a["masters/customcharts.src.js"];
});
...
(function (a) {
  "object" === typeof module && module.exports
    ...
    : "function" === typeof define && define.amd
    ? define("customcharts/modules/exporting", ["customcharts"], function (e) {
        a(e);
        a.customcharts = e;
        return a;
      })
    : a("undefined" !== typeof customcharts ? customcharts : void 0);
})(function (a) {
  function e(a, l, y, F) {
    a.hasOwnProperty(l) ||
      ((a[l] = F.apply(null, y)),
    ...
    function (a) {
      ...
      return {
        exporting: {
          ...
          buttons: {
            contextButton: {
              className: "customcharts-contextbutton",
              menuClassName: "customcharts-contextmenu",
              symbol: "menu",
      ...
      (function (e) {
        function F(a) {
          ...
          if (!1 !== b.enabled && b.theme) {
            ...
            r.menuClassName =
              a.menuClassName || "customcharts-menu-" + f.btnCount++;
            b.symbol &&
              ((x = d
                ...
                .addClass("customcharts-button-symbol")
                .attr({ zIndex: 1 })
                .add(r)),
              f.styledMode ||
                x.attr({
                ...
                b.separator
                  ...
                  : ("viewData" === b.textKey &&
                    ...
                    (f = G(
                      "li",
                      {
                        className: "customcharts-menu-item",
                        onclick: function (a) {
                          a && a.stopPropagation();
                          h.hideMenu();
...
(function (a) {
  "object" === typeof module && module.exports
    ...
    : "function" === typeof define && define.amd
    ? define(
        "customcharts/modules/export-data",
        ["customcharts", "customcharts/modules/exporting"],
        function (b) {
          a(b);
          a.customcharts = b;
          return a;
    ...
    function (a, b, e, p, n, C, r) {
      ...
      function Z(a) {
        ...
        const e = h ? a.shift() : null,
          ...
          p = function (a, b, c, d) {
            let e = v(d, "");
            b = "customcharts-text" + (b ? " " + b : "");
            "number" === typeof e
              ? ((e = e.toString()),
                "," === l && (e = e.replace(".", l)),
                (b = "customcharts-number"))
              : d || (b = "customcharts-empty");
            c = R({ class: b }, c);
        ...
        !1 !== d.exporting.tableCaption &&
          c.push({
            tagName: "caption",
            attributes: { class: "customcharts-table-caption" },
            textContent: v(
        ...
        c = {
          tree: {
            tagName: "table",
            id: `customcharts-data-table-${this.index}`,
            children: c,
          },
        };
      ...
      function ba(b) {
        ...
        c &&
          ...
          (this.dataTableDiv.className = "customcharts-data-table"),
          ...
          d &&
            d.childNodes.forEach((d) => {
              ...
              d.addEventListener("click", function () {
                ...
                f.forEach((a) => {
                  [
                    "customcharts-sort-ascending",
                    "customcharts-sort-descending",
                  ].forEach((b) => {
...
var cumEarlyStart = [0];
var cumLateStart = [0];
var cumActualStart = [0];

data.forEach(function (item, index) {
  labels.push(item.Month.substring(0, 7));
  earlyStart.push(item["Early Start"]);
  lateStart.push(item["Late Start"]);
  actualStart.push(item["Actual Start"]);
  cumEarlyStart.push(cumEarlyStart[index] + item["Early Start"]);
  cumLateStart.push(cumLateStart[index] + item["Late Start"]);
  if (item["Actual Start"] <= 0) cumActualStart.push(cumActualStart[index] * 0);
  else cumActualStart.push(cumActualStart[index] + item["Actual Start"]);
});
...
function transformLabelsToCategories(labels) {
...
let categories = transformLabelsToCategories(labels);
var cor = 0;
let plotLinesArray = [];
seriesData.forEach((series) => {
  if (series.type === "area") {
    series.data.forEach((value, index) => {
      cor += value;
      if (cor >= 10 && value === 0 && index > 0 && series.data[index - 1] > 0) {
        plotLinesArray.push({
          color: series.color.stops ? series.color.stops[0][1] : series.color,
          width: 2,
          value: index - 1,
          zIndex: 5,
        });
...
document.addEventListener("DOMContentLoaded", function () {
  customcharts.chart("container", {
    ...
    xAxis: [
      {
        ...
        labels: {
          useHTML: true,
          formatter: function () {
            const monthName = this.value;
            const labelIndex = this.pos;
            const fullDate = labels[labelIndex];
    ...
    yAxis: {
      ...
      labels: {
        style: {
          color: customcharts.getOptions().colors[1],
        },
      },
      title: {
        text: "",
